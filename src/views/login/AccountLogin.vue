...
<div>
    <el-form :model="loginForm" :rules="rules" ref="loginForm" class="demo-ruleForm">
        <el-form-item prop="username">
            <el-input v-model="loginForm.username" name="username" autocomplete="off"  placeholder="输入用户名/邮箱/手机号" size="medium">
                <el-button slot="prepend"  icon="el-icon-user"></el-button>
            </el-input>
        </el-form-item>
        <el-form-item prop="password">
            <el-input v-model="loginForm.password" @keyup.enter.native="submitForm('loginForm')" name="password" type="password"  placeholder="请输入登入密码" size="medium">
    ...
    <div >
        <el-dialog
                ...
                width="330px">
            <LoginValidation @successValidation="successValidation"/>
        </el-dialog>
    </div>
</div>
</template>
<script>
    ...
    import LoginValidation from "../../components/SliderValidation/Validation";
    export default {
        name: "AccountLogin",
        components:{
            LoginValidation
